...
exports.Server = {
	...
	reloadCSS: function () {
		const cssPath = '' + serverName + ''; // This should be the server id if Config.serverid doesn't exist. Ex: 'serverid'
	...
	giveDailyReward: function (user) {
		...
		user.send('|popup||wide||html| <center><u><b><font size="3">' + serverName + ' Daily Bonus</font></b></u><br>You have been awarded ' + reward + ' Bucks.<br>' + showDailyRewardAni(reward) + '<br>Because you have connected to the server for the past ' + (reward === 1 ? 'Day' : reward + ' Days') + '.</center>');
	},
};
