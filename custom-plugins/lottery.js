...
class Lottery {
	...
	drawWinner() {
		...
		this.room.add(`|html|<div class="infobox"><center><strong>Congratulations</strong> ${Server.nameColor(winner, true)}!!! You have won the reward of ${lottoPrize} ${currencyPlural}</center></div>`);
...
exports.commands = {
	...
	lottery: {
		...
		new: function (target, room, user) {
			...
			if (!this.can('lottery', null, room)) return false;
		...
		start: function (target, room, user) {
			if (!this.can('lottery', null, room)) return;
