...
function assembleOutput(output, marquee, shop, selectionType, back, update, user, room, cache) {
	...
	shop = '<div style="padding: 5px; border: 2px solid #101ad1; background: #6600CC; color: #fff; text-shadow: none; border-radius: 6px; margin: 10px"><center><font size=4><i><b>' + serverName + ' Server Shop</b></i></font></center></div><br/><br/>' + output;
...
function successfulTransaction(item, receipt, user, room) {
	...
	let output = '<div style="padding: 5px; border: 2px solid #000; background: #6600CC; color: #fff; text-shadow: none; border-radius: 6px; margin: 10px; text-align: center"><font size=4><i><b>' + serverName + ' Server Shop</b></i></font></div><br/><br/>';
