  ...
  profile: function(target, room, user) {
    ...
    let avatar = targetUser
      ? isNaN(targetUser.avatar)
        ...
        : `http://play.pokemonshowdown.com/sprites/trainers/${targetUser.avatar}.png`
      : Config.customavatars[userid]
      ? `http://${serverIp}/avatars/${Config.customavatars[userid]}`
      : `http://play.pokemonshowdown.com/sprites/trainers/1.png`;
    if (targetUser && targetUser.avatar[0] === "#")
      avatar = `http://play.pokemonshowdown.com/sprites/trainers/${targetUser.avatar.substr(
        1
      )}.png`;
